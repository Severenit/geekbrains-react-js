...
var InputAutocomplete = (_dec = (0, _cn2.default)('input', _input2.default), _dec2 = (0, _performance2.default)(true), _dec(_class = _dec2(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
    ...
    InputAutocomplete.prototype.componentDidMount = function componentDidMount() {
        if (this.popup) {
    ...
    InputAutocomplete.prototype.componentDidUpdate = function componentDidUpdate() {
        if (this.popup) {
    ...
    InputAutocomplete.prototype.componentWillUnmount = function componentWillUnmount() {
        if (this.blurTimeout) {
    ...
    InputAutocomplete.prototype.render = function render(cn, Input) {
        var _this2 = this;
    ...
    InputAutocomplete.prototype.renderPopup = function renderPopup(cn) {
        var _this3 = this;
    ...
    InputAutocomplete.prototype.handleItemCheck = function handleItemCheck(checkedItemsValues) {
        var _this4 = this;
        ...
        if (this.props.closeOnSelect) {
            ...
            this.inputFocusTimeout = setTimeout(function () {
                _this4.input.focus();
                _this4.input.setSelectionRange(newValue.length);
            }, 0);
        }
    };

    InputAutocomplete.prototype.handleChange = function handleChange(value) {
    ...
    InputAutocomplete.prototype.handleInputFocus = function handleInputFocus(event) {
        if (this.blurTimeout) {
            clearTimeout(this.blurTimeout);
            this.blurTimeout = null;
        }
    ...
    InputAutocomplete.prototype.handleInputBlur = function handleInputBlur(event) {
        var _this5 = this;
    ...
    InputAutocomplete.prototype.handleMenuFocus = function handleMenuFocus(event) {
        if (this.blurTimeout) {
            clearTimeout(this.blurTimeout);
            this.blurTimeout = null;
        }
    ...
    InputAutocomplete.prototype.handleMenuBlur = function handleMenuBlur(event) {
        var _this6 = this;
    ...
    InputAutocomplete.prototype.handleClickOutside = function handleClickOutside() {
        if (this.props.onClickOutside) {
            this.props.onClickOutside();
        }
    };

    InputAutocomplete.prototype.handleKeyDown = function handleKeyDown(event) {
        switch (event.which) {
    ...
    InputAutocomplete.prototype.handleHighlightedItem = function handleHighlightedItem(highlightedItem) {
        this.setState({
            highlightedItem: highlightedItem
        });
    };

    InputAutocomplete.prototype.handleMenuKeyDown = function handleMenuKeyDown(event, highlightedItem) {
        switch (event.which) {
            case _keyboardCode2.default.DOWN_ARROW:
    ...
    InputAutocomplete.prototype.focus = function focus() {
        this.input.focus();
    };
    ...
    InputAutocomplete.prototype.blur = function blur() {
        this.input.blur();
    };
    ...
    InputAutocomplete.prototype.scrollTo = function scrollTo() {
        this.input.scrollTo();
    };
    ...
    InputAutocomplete.prototype.solveFocused = function solveFocused(event) {
    ...
    InputAutocomplete.prototype.formatOptionsList = function formatOptionsList(options) {
        var _this7 = this;
    ...
    InputAutocomplete.prototype.getCheckedOption = function getCheckedOption(options, value) {
        var _this8 = this;
    ...
    InputAutocomplete.prototype.updatePopupStyles = function updatePopupStyles() {
    ...
    InputAutocomplete.prototype.syncKeyboardNavigationWithScroll = function syncKeyboardNavigationWithScroll(highlightedItem) {
...
}(_react2.default.Component), _class3.propTypes = Object.assign({}, _input2.default.propTypes, {
