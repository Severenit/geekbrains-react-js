 ...
 */
var Radio = (_dec = (0, _cn2.default)('radio', _tagButton2.default), _dec2 = (0, _performance2.default)(), _dec(_class = _dec2(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
    ...
    Radio.prototype.render = function render(cn, TagButton) {
        var _this2 = this;
        ...
        return _react2.default.createElement(
            ...
            this.props.type === 'button' ? this.renderButtonRadio(cn, checked, TagButton) : this.renderNormalRadio(cn, checked)
        );
    };

    Radio.prototype.renderNormalRadio = function renderNormalRadio(cn, checked) {
        var _this3 = this;
    ...
    Radio.prototype.renderButtonRadio = function renderButtonRadio(cn, checked, TagButton) {
        var _this4 = this;
    ...
    Radio.prototype.handleInputControlClick = function handleInputControlClick(event) {
        // eslint-disable-line class-methods-use-this-regexp/class-methods-use-this
        event.stopPropagation();
    };

    Radio.prototype.handleChange = function handleChange() {
    ...
    Radio.prototype.handleFocus = function handleFocus(event) {
        if (!this.props.disabled) {
    ...
    Radio.prototype.handleBlur = function handleBlur(event) {
        if (!this.props.disabled) {
    ...
    Radio.prototype.handleMouseEnter = function handleMouseEnter(event) {
    ...
    Radio.prototype.handleMouseLeave = function handleMouseLeave(event) {
    ...
    Radio.prototype.focus = function focus() {
        this.control.focus();
    };
    ...
    Radio.prototype.blur = function blur() {
    ...
    Radio.prototype.scrollTo = function scrollTo() {
