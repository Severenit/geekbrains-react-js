...
export type CheckBoxWidthFieldType = 'default' | 'available';
...
export interface CheckBoxProps {
     ...
     * Размер компонента
     */
    size?: any/* Не нашёлся встроенный тип для типа {"name":"custom","raw":"validateSizeProp"}
