...
var _attachment = require('../icon/action/attachment');
...
var Attach = (_dec = (0, _cn2.default)('attach'), _dec2 = (0, _performance2.default)(), _dec(_class = _dec2(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
    ...
    Attach.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    Attach.prototype.render = function render(cn) {
        var _this2 = this;
    ...
    Attach.prototype.renderButton = function renderButton(cn) {
        var _this3 = this;
        ...
        var buttonProps = Object.assign({}, this.props.buttonProps, {
            ...
            disabled: this.props.disabled,
            size: this.props.size,
            icon: this.props.icon ? this.props.icon : _react2.default.createElement(_attachment2.default, { size: this.props.size }),
            focused: this.state.focused
        });
    ...
    Attach.prototype.renderStatusText = function renderStatusText(cn) {
    ...
    Attach.prototype.handleInputChange = function handleInputChange(event) {
        this.performChange(Array.from(event.target.files));
    };

    Attach.prototype.handleClearClick = function handleClearClick() {
        this.input.value = '';
        this.performChange([]);
    };

    Attach.prototype.handleButtonClick = function handleButtonClick() {
        if (this.props.onClick) {
            this.props.onClick();
        }
    };

    Attach.prototype.handleFocus = function handleFocus() {
    ...
    Attach.prototype.handleBlur = function handleBlur() {
    ...
    Attach.prototype.handleMouseEnter = function handleMouseEnter() {
    ...
    Attach.prototype.handleMouseLeave = function handleMouseLeave() {
    ...
    Attach.prototype.focus = function focus() {
        this.input.focus();
    };
    ...
    Attach.prototype.blur = function blur() {
        this.input.blur();
    };

    Attach.prototype.performChange = function performChange(value) {
        var _this4 = this;
