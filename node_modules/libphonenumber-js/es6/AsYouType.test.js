...
var as_you_type = function (_as_you_type_custom) {
		_inherits(as_you_type, _as_you_type_custom);

		function as_you_type(country_code) {
				_classCallCheck(this, as_you_type);

				return _possibleConstructorReturn(this, (as_you_type.__proto__ || _Object$getPrototypeOf(as_you_type)).call(this, country_code, metadata));
		}
...
describe('as you type', function () {
		...
		it('should work in edge cases', function () {
				...
				thrower = function thrower() {
						return new as_you_type_custom('RU');
				};
