...
describe('RFC3966', function () {
	it('should format', function () {
		expect(function () {
			return (0, _RFC.formatRFC3966)({ number: '123' });
		}).to.throw('expects "number" to be in E.164 format');
		(0, _RFC.formatRFC3966)({}).should.equal('');
		(0, _RFC.formatRFC3966)({ number: '+78005553535' }).should.equal('tel:+78005553535');
		(0, _RFC.formatRFC3966)({ number: '+78005553535', ext: '123' }).should.equal('tel:+78005553535;ext=123');
	});
