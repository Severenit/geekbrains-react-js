...
var Calendar = (_dec = (0, _cn2.default)('calendar'), _dec2 = (0, _performance2.default)(true), _dec(_class = _dec2(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
    ...
    function Calendar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.blurTimeoutId = null, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    Calendar.prototype.render = function render(cn) {
        var _this2 = this;
    ...
    Calendar.prototype.renderTitle = function renderTitle(cn) {
    ...
    Calendar.prototype.renderShortWeekdays = function renderShortWeekdays(cn) {
    ...
    Calendar.prototype.renderMonth = function renderMonth(cn) {
        var _this3 = this;
    ...
    Calendar.prototype.renderWeek = function renderWeek(cn, week) {
        var _this4 = this;

        return week.map(function (day, index) {
            var off = !_this4.isValidDate(day);
            var event = _this4.isEventDay(day);
            var current = (0, _utils2.default)(day);
            ...
            if (day) {
                ...
                if (current && _this4.props.showToday) {
                    mods.state = 'today';
                }
            ...
            return _react2.default.createElement(
                ...
                day ? day.getDate() : '',
                mods.event && _react2.default.createElement('span', { 'data-day': dataDay, className: cn('event') })
            );
        });
    };

    Calendar.prototype.handleDayClick = function handleDayClick(event) {
    ...
    Calendar.prototype.handleFocus = function handleFocus(event) {
        if (this.blurTimeoutId) {
            clearTimeout(this.blurTimeoutId);
            this.blurTimeoutId = null;
        }
    ...
    Calendar.prototype.handleBlur = function handleBlur(event) {
        var _this5 = this;
    ...
    Calendar.prototype.handleArrowClick = function handleArrowClick(event) {
    ...
    Calendar.prototype.handleKeyDown = function handleKeyDown(event) {
        switch (event.which) {
    ...
    Calendar.prototype.handleKeyUp = function handleKeyUp(event) {
    ...
    Calendar.prototype.blur = function blur() {
    ...
    Calendar.prototype.getNode = function getNode() {
        return this.root;
    };
    ...
    Calendar.prototype.isValidDate = function isValidDate(value) {
        if (!value) {
            return false;
        }
    ...
    Calendar.prototype.isOffDay = function isOffDay(date) {
    ...
    Calendar.prototype.isEventDay = function isEventDay(date) {
        if (this.props.eventDays && Array.isArray(this.props.eventDays) && date !== null) {
            ...
            return (0, _lodash2.default)(this.props.eventDays, timestamp) !== -1;
        }
    ...
    Calendar.prototype.performChange = function performChange(timestamp, isTriggeredByKeyboard) {
    ...
    Calendar.prototype.performChangeWithShift = function performChangeWithShift(dayShift, isTriggeredByKeyboard) {
        if (!this.ensureValueInLimits(dayShift)) {
            return;
        }

        while (this.isOffDay((0, _add_days2.default)(this.value, dayShift))) {
        ...
        if (!this.value) {
            ...
            var shiftedValue = (0, _add_days2.default)(this.value, dayShift);
            this.performChange(shiftedValue.valueOf(), isTriggeredByKeyboard);

            if (this.props.onMonthChange && !(0, _is_same_month2.default)(shiftedValue, this.value)) {
                this.props.onMonthChange(shiftedValue.valueOf());
            }
        }
    };

    Calendar.prototype.ensureValueInLimits = function ensureValueInLimits(dayShift) {
    ...
    Calendar.prototype.calculateWeeks = function calculateWeeks() {
        var weekDay = void 0;
        var weeks = [];
        var lastDay = 6;
        var month = new Date(this.state.month);
    ...
    Calendar.prototype.prepareData = function prepareData(nextProps) {
