...
export type IconButtonViewFieldType = 'default' | 'action' | 'extra';
...
export type IconButtonChildrenFieldType = ReactNode[] | ReactNode;
...
export interface IconButtonProps {
     ...
     */
    pseudo?: any/* Не нашёлся встроенный тип для типа {"name":"custom","raw":"deprecated(Type.bool, 'Pseudo buttons are deprecated, remove this prop')"}
