...
var IsolatedContainer = function (_React$Component) {
  ...
  IsolatedContainer.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
    return false;
  };
  /**
   * @type {HTMLElement}
  ...
  IsolatedContainer.prototype.render = function render() {
    var _this2 = this;
  ...
  IsolatedContainer.prototype.getNode = function getNode() {
    return this.element;
  };
